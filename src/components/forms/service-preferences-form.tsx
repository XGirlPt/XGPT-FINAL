...
export const ServicePreferencesForm = () => {
  ...
  const [categories, setCategories] = useState<PreferenceCategory[]>([
    ...
    },
    {
      ...
      options: [
        { id: 'pt', label: t('language.pt'), checked: linguaRedux.includes('Portuguese') },
        { id: 'en', label: t('language.en'), checked: linguaRedux.includes('English') },
        { id: 'fr', label: t('language.fr'), checked: linguaRedux.includes('French') },
        { id: 'es', label: t('language.es'), checked: linguaRedux.includes('Spanish') },
        { id: 'de', label: t('language.de'), checked: linguaRedux.includes('German') },
        { id: 'it', label: t('language.it'), checked: linguaRedux.includes('Italian') },
        { id: 'ru', label: t('language.ru'), checked: linguaRedux.includes('Russian') },
        { id: 'ar', label: t('language.ar'), checked: linguaRedux.includes('Arabic') },
      ],
    },
    {
      id: 'services',
