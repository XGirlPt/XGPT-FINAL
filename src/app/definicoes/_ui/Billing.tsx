  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg mb-4 shadow-lg h-full">
      ...
      <p className="text-gray-300 mb-6">
        Para acessar todas as funcionalidades do nosso site, é necessária uma
        assinatura mensal de
        <span className="font-bold text-pink-500"> 10 EUR</span>. Os pagamentos
        são processados através do{' '}
        <span className="font-bold text-pink-500">Verotel</span>.
      </p>
      ...
      <div className="bg-gray-700 p-4 rounded-lg mb-6">
        <ul className="list-disc list-inside text-gray-300">
          <li>
            Subscrição: <span className="font-bold">10 EUR</span>
          </li>
      ...
      <div className="bg-gray-700 p-4 rounded-lg mb-6">
        ...
        <ul className="list-disc list-inside text-gray-300">
          <li>
            Data da Assinatura:{' '}
            <span className="font-bold">15 de Outubro de 2024</span>
          </li>
          <li>
            Data da Próxima Mensalidade:{' '}
            <span className="font-bold">15 de Novembro de 2024</span>
          </li>
        </ul>
      </div>
      ...
      <p className="text-gray-300 mb-4">
        Aqui você pode visualizar seu histórico de pagamentos e status de
        assinatura.
