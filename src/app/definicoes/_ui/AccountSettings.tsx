...
const AccountSettings: React.FC = () => {
  ...
  const toggleStatus = async () => {
    try {
      ...
      const message = newStatus
        ? 'Your Profile has been Successfully Reactivated.'
        : 'Your Profile has been Temporarily Suspended Successfully.';
  ...
  useEffect(() => {
    const fetchStatus = async () => {
      try {
        const currentStatus =
          await profileDataService.fetchProfileStatus(userUID);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-900 rounded-lg">
      ...
      <p className="text-gray-300 mb-6">
        Gerencie sua conta e suas preferências. Você pode suspender
        temporariamente ou eliminar sua conta definitivamente.
      </p>
      ...
      <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              {status
                ...
                : 'Sua conta está suspensa. Clique para reativar.'}
            </p>
          </div>
          <button
            ...
            className={`py-2 px-4 rounded-lg transition-all ${
              status
                ? 'bg-pink-800 text-white hover:bg-pink-600'
        ...
        <ModalConfirmation
          ...
          message={
            status
              ? 'Tem certeza de que deseja suspender sua conta? Você pode reativá-la a qualquer momento.'
              : 'Tem certeza de que deseja reativar sua conta?'
          }
