...
const RegistoFotos: React.FC = () => {
  ...
  const [VselectedPhotos, VsetSelectedPhotos] =
    useState<string[]>(vphotosFromRedux);
  ...
  const handleVerificationPhotoUpload = async (
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2 mx-2 my-4">
                {selectedPhotos.length < 10 &&
                  Array.from({ length: 10 - selectedPhotos.length }).map(
                    (_, index) => (
        ...
        <DialogFooter className="bg-gray-800 pb-4 flex justify-around">
          <Link href="/registo/registo-contacto">
            <Button
              variant="voltar"
              color="secondary"
              className="px-6 py-3 bg-gray-500 hover:bg-gray-700 text-white rounded-lg text-sm font-medium transition"
            >
              {t('button.back')}
            </Button>
          </Link>
          <Link href="/registo/registo-pagamento">
            <Button
              variant="guarder"
              color="primary"
              className="px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm font-medium transition"
            >
