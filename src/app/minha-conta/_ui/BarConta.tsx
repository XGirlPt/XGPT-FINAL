    ...
    <aside className="bg-gray-800 px-6 mt-10 w-72 shadow-xl flex flex-col">
      ...
      <nav className="space-y-4">
        ...
        >
          ...
          <span className="ml-4 hidden lg:block">{t('MyProfileBar.info')}</span>
        </button>
